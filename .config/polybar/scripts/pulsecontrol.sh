...
# Get with `pactl list sinks short`
SINK_BLACKLIST=(
...
SINK_NICKNAMES["alsa_output.usb-C-Media_Electronics_Inc._USB_Multimedia_Audio_Device-00.iec958-stereo"]="USB"
